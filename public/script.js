document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      // Submit via fetch if action attribute exists, otherwise dispatch custom event
      ...
      if (action) {
        fetch(action, {
          ...
          .catch(function () {
            const errorMsg = contactForm.querySelector('.form-general-error');
            if (errorMsg) {
        ...
        const submitEvent = new CustomEvent('contactFormSubmit', {
          bubbles: true,
          detail: { formData: formData, form: contactForm }
        });
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "תות תלוי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '8aecb9a5-a0a6-43f5-b321-bba7c78e65c0',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '8aecb9a5-a0a6-43f5-b321-bba7c78e65c0';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '8aecb9a5-a0a6-43f5-b321-bba7c78e65c0';
